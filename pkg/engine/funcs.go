...
func funcMap() template.FuncMap {
	...
	extra := template.FuncMap{
		...
		// late-bound to a templates. By declaring it here, we preserve the
...
//
// This is designed to be called from a templates.
func toYAML(v interface{}) string {
	data, err := yaml.Marshal(v)
	if err != nil {
		// Swallow errors inside of a templates.
		return ""
	}
...
//
// This is not a general-purpose YAML engine, and will not parse all valid
...
//
// This is not a general-purpose JSON engine, and will not parse all valid
